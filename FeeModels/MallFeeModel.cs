...
namespace aiico.FeeModels
{
    ...
    public class MallFeeModel : IFeeModel
    {
        ...
        private decimal CalculateMotorcycleFee(TimeSpan duration)
        {
            ...
            decimal totalFee = hours * ParkingLotConstants.FeeModelConstants.Mall.MotorcycleHourlyFee;
            return totalFee;
        }
        ...
        {
            int hours = (int)Math.Ceiling(duration.TotalHours);
            decimal totalFee = hours * ParkingLotConstants.FeeModelConstants.Mall.CarSUVHourlyFee;
            return totalFee;
        }
        ...
        {
            int hours = (int)Math.Ceiling(duration.TotalHours);
            decimal totalFee = hours * ParkingLotConstants.FeeModelConstants.Mall.BusTruckHourlyFee;
            return totalFee;
        }
    }
}